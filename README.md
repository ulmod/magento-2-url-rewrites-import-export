# Magento 2 URL Rewrites Import Export Extension

[Magento 2 URL Rewrites Import Export](https://www.ulmod.com/url-rewrites-export-import-for-magento-2.html)  is a Magento 2 extension that allows you to easily export and import URL rewrites including all data.

With Magento 2 URL Rewrites Import and Export, you can easily create URL rewrites in bulk or transfer between Magento 2 sites/installations. 

<a href="https://www.ulmod.com/url-rewrites-export-import-for-magento-2.html"><img width="205" src="https://www.ulmod.com/media/wysiwyg/um-download-now1.png"></a>

## Key Features

* Export any number of URL rewrites into a CSV file including all data (eg. entity_type, product_id, category_id, cmspage_id, store_id, request_path, target_path, redirect_type, description )
* Ability to export URL rewrites by store view, entity type, and redirect type
* Import any number of URL rewrites items via a CSV file, including all rewrites data
* Ability to  split the export file into multiple small files
* Support sample import CSV file right in the Import settings
* Support three import behaviors: add/update, replace and delete
* Ability to validate rewrite CSV file before any import and show the results
* Support export history, ability to manage all rewrites export log from the backend
* Ability to delete rewrites export logs manually or automatically


<img src="https://www.ulmod.com/media/ulmod/product_content/rewrite-export-f.png">
<img src="https://www.ulmod.com/media/ulmod/product_content/rewrite-import-f.png">
<img src="https://www.ulmod.com/media/ulmod/product_content/rewrite-export-log.png">
